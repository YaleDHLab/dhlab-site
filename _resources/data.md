...
What about for material that hasn't been digitized yet? Scanners in the Digital Humanities Lab may be used by recipients who have a current Seed Grant award from the lab for the purposes of creating digital corpora for mining purposes (rather than for textual preservation or personal archives). For longer duration or all-purpose scanning, researchers may use the machines in the Nave of Sterling Memorial Library or in the lower level of Bass Library. 
